...
require_once dirname( __DIR__, 2 ) . '/lib/models/api/ifthenpay-lp-key-validator.php';
require_once dirname( __DIR__, 2 ) . '/lib/models/validation/ifthenpay-lp-backoffice-key-validation.php';
